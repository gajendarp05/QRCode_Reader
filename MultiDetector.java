...
public class QRCodeMain {
    private static void detectQRCode(File qrCodeimage) throws IOException {
        ...
        try {
            DetectorResult[] result = new MultiDetector(bitmap.getBlackMatrix()).detectMulti(null);
            for (DetectorResult i: result) {
                System.out.println(i.getBits());
            }
